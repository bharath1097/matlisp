...
;;		 :for s :across stds
;;		 :for d :across dims
;;		 :summing (the index-type (* s d)) :into sz :of-type index-type
;;		 :do (progn
;;		       (assert (and (>= s sz) (> s 0)) nil 'tensor-invalid-stride-value :argument i :stride s :tensor tensor)
;;		       (assert (> d 0) nil 'tensor-invalid-dimension-value :argument i :dimension d :tensor tensor))
